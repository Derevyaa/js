...
let ageT = 20;
let message = ageT >= 18 ? "Ви маєте право голосу." : "Ви ще надто молоді для голосування.";
console.log(message);
...
let score1 = 75;
let grade1 = score1 >= 90 ? 'A' : (score1 >= 80 ? 'B' : (score1 >= 70 ? 'C' : 'D'));
