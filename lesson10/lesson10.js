...
/**У регулярних виразах можна використовувати посилання, які дозволяють посилатися на групи або підвирази, що вже були знайдені. Це дозволяє створювати складніші шаблони для пошуку тексту.
У JavaScript ви можете використовувати посилання на групи за допомогою \n, де n - це номер групи.
Отже, наприклад, якщо ви хочете знайти парні теги HTML (наприклад, <p>...</p>, <div>...</div>, то можна скористатися посиланням на групу. Ось приклад такого регулярного виразу:
 */
...
.*? - Це відповідає будь-якому символу (включаючи новий рядок), який повторюється нуль або більше разів, у не жадібний спосіб. Це означає, що воно спробує знайти найменше можливе співпадіння.
<\/\1> - Це літерал закриваючого тега HTML, який починається з </, за яким слідує те саме ім'я тега, що й відкриваючий тег. \1 вказує на посилання на першу групу (тобто ім'я тега).
Отже, цей регулярний вираз знаходить парні HTML теги у тексті, які відповідають заданому шаблону. У вашому випадку, він знаходить <div>...</div> та <b>...</b>, оскільки вони є парними HTML тегами.
 */
